...
impl RuntimeError {
    pub fn name(&self) -> &'static str {
        match self {
            RuntimeError::Serialization(_) => "SerializationException",
            RuntimeError::InternalFailure(_) => "InternalFailureException",
            RuntimeError::UnknownOperation => "UnknownOperationException",
            RuntimeError::NotAcceptable => "NotAcceptableException",
        }
    }
}
